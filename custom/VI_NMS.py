#coding:utf-8
import numpy as np
from Constants import baseDir,yolo_result_dir,merge_result_txt,final_detect_result
import os
import json
from IPython.core.debugger import Pdb
from astropy.modeling.projections import Conic
import pdb
...
#     f = open("final_detect_result.json","w")
    f = open(final_detect_result,"w")
    json.dump(out_data,f)    
    print("save file to:",final_detect_result)
