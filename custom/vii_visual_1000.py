...
import os
import cv2
from Constants import final_detect_result_1000,VIII_visual_dir_1000
import json
...
def readFinalResult():
    fp = open(final_detect_result_1000) 
    boxes = json.load(fp)
...
if __name__ =="__main__":
    ...
    for idx,img_name in enumerate(images):
        ...
        save_path = os.path.join(VIII_visual_dir_1000,img_name)
