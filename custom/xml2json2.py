...
import os
import json
# 若visdrone直接转coco格式可以使用txt2json_visdrone.py
...
pre_define_cat_item_id={"pedestrian":1}
...
#     category_item_id += 1
    category_item_id = pre_define_cat_item_id[name]
...
if __name__ == '__main__':
    xml_path = '/home/jjliao/Visdrone_coco/VisDrone2019-DET-val/annotations_xml'
    json_file = './annotations/instances_val__.json'
